...
A complex form builder designed for creating and parsing recurrence rules (RRULE) compatible with the iCalendar RFC 5545
standard. Ideal for calendars, scheduling systems, and recurring event management.
