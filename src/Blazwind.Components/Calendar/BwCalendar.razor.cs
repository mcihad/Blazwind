...
public partial class BwCalendar : IAsyncDisposable, IDisposable
{
    ...
    */
    ...
    public string GetTodayHeaderClass() => TodayColor switch
    {
    ...
    public string GetTodayBackgroundClass() => TodayColor switch
    {
    ...
    public string GetTodayTextClass() => TodayColor switch
    {
