...
{
    [JsonPropertyName("title")] public ChartTitle? Title { get; set; }

    [JsonPropertyName("tooltip")] public ChartTooltip? Tooltip { get; set; }

    [JsonPropertyName("legend")] public ChartLegend? Legend { get; set; }

    [JsonPropertyName("grid")] public ChartGrid? Grid { get; set; }

    [JsonPropertyName("xAxis")] public object? XAxis { get; set; }

    [JsonPropertyName("yAxis")] public object? YAxis { get; set; }

    [JsonPropertyName("series")] public List<ChartSeries>? Series { get; set; }
    ...
    [JsonPropertyName("animation")] public bool Animation { get; set; } = true;
...
public class ChartTitle
{
    ...
    [JsonPropertyName("left")] public string Left { get; set; } = ChartPosition.Center;

    [JsonPropertyName("top")] public string Top { get; set; } = ChartPosition.Top;

    [JsonPropertyName("bottom")] public string? Bottom { get; set; }

    [JsonPropertyName("textStyle")] public ChartTextStyle? TextStyle { get; set; }
}
...
public class ChartTooltip
{
    ...
    [JsonPropertyName("trigger")] public string Trigger { get; set; } = ChartTooltipTrigger.Item; // item, axis, none

    [JsonPropertyName("triggerOn")] public string? TriggerOn { get; set; }
...
public class ChartLegend
{
    ...
    [JsonPropertyName("type")] public string Type { get; set; } = ChartLegendType.Plain; // plain, scroll
    ...
    [JsonPropertyName("top")] public string Top { get; set; } = ChartPosition.Bottom;
...
{
    [JsonPropertyName("left")] public object Left { get; set; } = "10%";

    [JsonPropertyName("right")] public object Right { get; set; } = "10%";

    [JsonPropertyName("bottom")] public object Bottom { get; set; } = "15%";

    [JsonPropertyName("top")] public object Top { get; set; } = "15%";

    [JsonPropertyName("width")] public object? Width { get; set; }

    [JsonPropertyName("height")] public object? Height { get; set; }

    [JsonPropertyName("containLabel")] public bool ContainLabel { get; set; } = true;
}
...
{
    [JsonPropertyName("type")] public string Type { get; set; } = ChartAxisType.Category; // category, value, time, log
    ...
    [JsonPropertyName("nameGap")] public int? NameGap { get; set; }

    [JsonPropertyName("boundaryGap")] public object? BoundaryGap { get; set; }

    [JsonPropertyName("axisLabel")] public ChartAxisLabel? AxisLabel { get; set; }
    ...
    [JsonPropertyName("splitArea")] public object? SplitArea { get; set; }

    [JsonPropertyName("splitLine")] public object? SplitLine { get; set; }

    [JsonPropertyName("axisLine")] public object? AxisLine { get; set; }

    [JsonPropertyName("axisTick")] public object? AxisTick { get; set; }
...
{
    [JsonPropertyName("type")] public string Type { get; set; } = ChartSeriesType.Line;
    ...
    [JsonPropertyName("xAxisIndex")] public int? XAxisIndex { get; set; }

    [JsonPropertyName("yAxisIndex")] public int? YAxisIndex { get; set; }

    [JsonPropertyName("data")] public object? Data { get; set; }

    [JsonPropertyName("stack")] public string? Stack { get; set; }

    [JsonPropertyName("smooth")] public bool Smooth { get; set; } = false;

    [JsonPropertyName("step")] public string? Step { get; set; }

    [JsonPropertyName("connectNulls")] public bool ConnectNulls { get; set; }

    [JsonPropertyName("showSymbol")] public bool ShowSymbol { get; set; } = true;
    ...
    [JsonPropertyName("itemStyle")] public ChartItemStyle? ItemStyle { get; set; }

    [JsonPropertyName("label")] public ChartLabel? Label { get; set; }

    [JsonPropertyName("radius")] public object? Radius { get; set; } // For pie charts: ["40%", "70%"]

    [JsonPropertyName("center")] public List<string>? Center { get; set; } // For pie charts: ["50%", "50%"]

    [JsonPropertyName("roseType")] public string? RoseType { get; set; } // For pie charts: area, radius

    [JsonPropertyName("emphasis")] public ChartEmphasis? Emphasis { get; set; }
    ...
    [JsonPropertyName("force")] public object? Force { get; set; }

    [JsonPropertyName("roam")] public bool Roam { get; set; }
    ...
    // Bar Race
    [JsonPropertyName("realtimeSort")] public bool RealtimeSort { get; set; }

    [JsonPropertyName("seriesLayoutBy")] public string? SeriesLayoutBy { get; set; }
    ...
    [JsonPropertyName("pointer")] public object? Pointer { get; set; }
}
...
public class ChartItemStyle
{
    ...
    [JsonPropertyName("shadowBlur")] public int? ShadowBlur { get; set; }

    [JsonPropertyName("shadowColor")] public string? ShadowColor { get; set; }
...
public class ChartLabel
{
    ...
    [JsonPropertyName("position")] public string Position { get; set; } = ChartPosition.Top;
