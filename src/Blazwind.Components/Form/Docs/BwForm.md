...
The Blazwind Form system is a comprehensive suite of components designed to manage complex input layouts, validation states, and consistent styling across your application.

## Core Components

- **`BwForm`**: The master container. It manages the `EditContext`, coordinates validation, and cascades global settings like density and label positioning.
- **`BwFormField`**: A wrapper for individual inputs. Handles labels, help text (inline or popup), error messages, and required indicators.
