...
A specialized component used to inform users when a list is empty, search results are not found, or content hasn't been
created yet. It provides a clean, centered interface with optional illustrations and actions.

## Features

- ✅ **Visual Flexibility:** Support for default SVG illustrations, custom FontAwesome icons, or custom `RenderFragment`
  images.
