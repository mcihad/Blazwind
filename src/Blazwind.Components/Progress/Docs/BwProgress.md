...
A visual indicator used to show the completion status of a task or a process. Supports multiple colors, sizes, and
interactive styling like stripes and animations.
