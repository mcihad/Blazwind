...
A component that enables "Endless Scrolling" or "Load More" functionality by detecting when the user reaches the bottom
of the container. Ideal for feeds, logs, and paginated API results.
