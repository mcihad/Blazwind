...
A component for generating and rendering SVG-based QR codes. Highly customizable and efficient, ideal for URLs, contact
information, and configuration sharing.
