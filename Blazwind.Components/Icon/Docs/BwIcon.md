...
A lightweight wrapper component for FontAwesome and other icon sets, providing standardized sizing and color themes consistent with the Blazwind design system.
...
## Technical Note
This component inherits from `BwBase`, allowing it to accept standard `Style` and `AdditionalAttributes` (e.g., `title`, `aria-label`).
